...
<s:elseif test="resultClass==NULL"> <!-- 일반 글쓰기할때 -->
	<form action="writeAction.action" method="post" enctype="multipart/form-data" onsubmit="return validation();">
</s:elseif>

<s:else><!-- 글 수정할때 -->
	<form action="modifyAction.action" method="post" enctype="mutipart/form-data">
...
<tr>
	...
	<td bgcolor="#FFFFFF">
		...
		<s:password name="password" theme="simple" value="%{resultClass.password}" cssStyle="width:100px" maxlength="20"/>
	</td>
</tr>
<tr bgcolor="#777777">
	<td height="1" colspan="2"></td>
